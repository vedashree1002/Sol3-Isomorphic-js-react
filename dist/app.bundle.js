...
/* harmony import */ var _shared_comp_Layout__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared-comp/Layout */ "./shared-comp/Layout.js");
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.hydrate(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_shared_comp_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], null), app);

/***/ }),

/***/ "./shared-comp/Layout.js":
/*!*******************************!*\
  !*** ./shared-comp/Layout.js ***!
  \*******************************/
  ...
  _createClass(Layout, [{
    ...
    value: function handleChange(e) {
      ...
      this.setState({ city: e.target.value }, function () {
        console.log("City entered: ", _this2.state.city);
      });
    ...
    value: function handleSubmit(e) {
      ...
      var url = 'http://api.openweathermap.org/data/2.5/weather?appid=55425e58955279263b6f5f14dd79be6b&q=' + this.state.city;
      console.log("URL " + url);
      fetch(url).then(function (response) {
        ...
        _this3.setState({ temp: temp }, function () {
          alert("Current temperature in " + _this3.state.city + " is " + _this3.state.temp + ' \xB0F.');
        });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          'h3',
          null,
          'Please enter the city to find out the current weather '
        ),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          'form',
          null,
          react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', { type: 'text', style: input, value: this.state.city, onChange: function onChange(e) {
          ...
          react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            'button',
            { type: 'submit', style: submit, onClick: this.handleSubmit },
            'SUBMIT'
          )
        )
      );
